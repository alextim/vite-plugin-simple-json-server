...
export function handleHtml(req: Connect.IncomingMessage, res: ServerResponse, staticRoot: string, purePath: string, logger: ILogger) {
  ...
  switch (req.method) {
    case 'OPTIONS':
      return sendOptions(res, ['GET'], [filePath], logger);
    case 'GET':
